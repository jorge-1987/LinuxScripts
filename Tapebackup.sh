...
echo "=================================================="
echo "1: Backupear un archivo / Backup a file           "
echo "2: Restaurar desde de la cinta / Restore from Tape"
echo "3: Listar archivos en cinta / List files on Tape  "
echo "4: Salir / Quit                                   "
echo "5: Rebobinar la Cinta / rewind                    "
echo "6: Borar la cinta / Erase the Tape                "
echo "7: Status de la Cinta / Status of the Tape        "
